...
type ValidationIssue struct {
	...
	Suggestion string `json:"suggestion,omitempty"` // Optional suggestion for fixing the issue
}
...
type ValidationResult struct {
	...
	Errors   []ValidationIssue `json:"errors,omitempty"`   // List of error-level issues
	Warnings []ValidationIssue `json:"warnings,omitempty"` // List of warning-level issues
}
